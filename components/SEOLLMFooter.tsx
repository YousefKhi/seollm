        ...
        <div className="grid lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center space-x-2 mb-6">
              ...
              <span className="font-bold text-xl text-gray-900">seollm.ca</span>
            </div>
            <p className="text-gray-600 leading-relaxed mb-6">
              Monitor and optimize your brand's visibility across AI platforms. 
        ...
        <div className="border-t border-gray-200 mt-8 pt-8">
          <div className="flex flex-col lg:flex-row justify-between items-center">
            <p className="text-gray-500 text-sm">
              © 2024 seollm.ca. All rights reserved.
            </p>
            <div className="flex items-center space-x-6 mt-4 lg:mt-0">
              <Link href="/status" className="text-gray-500 hover:text-gray-900 text-sm transition-colors">
                Status
              </Link>
              <Link href="/security" className="text-gray-500 hover:text-gray-900 text-sm transition-colors">
                Security
              </Link>
            </div>
          </div>
